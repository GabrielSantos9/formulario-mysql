...
const { cadastrarUsuario, listarUsuarios } = require("../controladores/controleUsuarios"); // Importa a função "cadastrarUsuario" do arquivo "controleUsuarios.js", que é responsável por lidar com o cadastro de usuários no banco de dados. Essa função será usada como callback para a rota POST definida abaixo.
